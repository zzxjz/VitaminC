...
u32 Bus11_Load32(struct ARM11MPCore* ARM11, const u32 addr);
u8 Bus11_Load8(struct ARM11MPCore* ARM11, const u32 addr);
void Bus11_Store32(struct ARM11MPCore* ARM11, const u32 addr, const u32 val);
void Bus11_Store8(struct ARM11MPCore* ARM11, const u32 addr, const u8 val);
